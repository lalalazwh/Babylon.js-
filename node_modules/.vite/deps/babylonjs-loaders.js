          ...
          var __webpack_modules__ = {
            ...
            "../../../dev/loaders/src/SPLAT/index.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                __webpack_require__2.d(__webpack_exports__2, {
                  ...
                  SPLATFileLoader: () => (
                    /* reexport safe */
                    _splatFileLoader__WEBPACK_IMPORTED_MODULE_0__.SPLATFileLoader
                  )
                  /* harmony export */
                });
                var _splatFileLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__2(
                  /*! ./splatFileLoader */
            ...
            "../../../dev/loaders/src/SPLAT/splatFileLoader.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                var babylonjs_Loading_sceneLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__2(
                  /*! babylonjs/Rendering/GaussianSplatting/gaussianSplatting */
                  "babylonjs/Misc/observable"
                );
                ...
                var SPLATFileLoader = (
                  ...
                  function() {
                    ...
                    SPLATFileLoader2.prototype.createPlugin = function() {
                      return new SPLATFileLoader2();
                    };
                    SPLATFileLoader2.prototype.canDirectLoad = function() {
                      return false;
                    };
                    SPLATFileLoader2.prototype._loadPLY = function(data) {
                      ...
                      for (var _i = 0, filtered_1 = filtered; _i < filtered_1.length; _i++) {
                        ...
                        var _a = prop.split(" "), _p = _a[0], type = _a[1], name_1 = _a[2];
                        properties.push({ name: name_1, type, offset: rowOffset });
                        if (!offsets[type])
                          throw new Error("Unsupported property type: ".concat(type));
                      ...
                      var q = new babylonjs_Loading_sceneLoader__WEBPACK_IMPORTED_MODULE_0__.Quaternion();
                      for (var i = 0; i < vertexCount; i++) {
                        var position = new Float32Array(buffer, i * rowLength, 3);
                        var scale = new Float32Array(buffer, i * rowLength + 12, 3);
                        var rgba = new Uint8ClampedArray(buffer, i * rowLength + 24, 4);
                        var rot = new Uint8ClampedArray(buffer, i * rowLength + 28, 4);
                        var r0 = 255;
                        var r1 = 0;
                        var r2 = 0;
                        var r3 = 0;
                        for (var propertyIndex = 0; propertyIndex < properties.length; propertyIndex++) {
                          ...
                          switch (property.type) {
                            ...
                            case "int":
                              ...
                              break;
                            default:
                              throw new Error("Unsupported property type: ".concat(property.type));
                          }
                    ...
                    SPLATFileLoader2.prototype.importMeshAsync = function(_meshesNames, scene, data, rootUrl) {
                      var gaussianSplatting = new babylonjs_Loading_sceneLoader__WEBPACK_IMPORTED_MODULE_0__.GaussianSplatting("", scene);
                      return gaussianSplatting.loadFileAsync(rootUrl);
                    };
                    SPLATFileLoader2.prototype.loadAsync = function(scene, data, _rootUrl) {
                      var gaussianSplatting = new babylonjs_Loading_sceneLoader__WEBPACK_IMPORTED_MODULE_0__.GaussianSplatting("GaussianSplatting", scene);
                      return gaussianSplatting.loadDataAsync(this._loadPLY(data));
                    };
                    SPLATFileLoader2.prototype.loadAssetContainerAsync = function(_scene, _data, _rootUrl) {
                  ...
                  __array__: {
                    ...
                    extensions: {
                      ...
                      KHR_materials_dispersion: {
                        dispersion: [new MaterialAnimationPropertyInfo(babylonjs_Animations_animation__WEBPACK_IMPORTED_MODULE_0__.Animation.ANIMATIONTYPE_FLOAT, "subSurface.dispersion", getFloat, function() {
                          return 1;
                        })]
                      },
            ...
            "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_animation_pointer.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                var _gltfPathToObjectConverter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__2(
                  /*! ./gltfPathToObjectConverter */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/gltfPathToObjectConverter.ts"
                );
                var NAME = "KHR_animation_pointer";
                var AnimationPointerPathToObjectConverter = (
                  /** @class */
                  function(_super) {
                    (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__extends)(AnimationPointerPathToObjectConverter2, _super);
                    function AnimationPointerPathToObjectConverter2(gltf) {
                      return _super.call(this, gltf, _KHR_animation_pointer_data__WEBPACK_IMPORTED_MODULE_2__.animationPointerTree) || this;
                    }
                    return AnimationPointerPathToObjectConverter2;
            ...
            "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_interactivity.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                var babylonjs_FlowGraph_flowGraphCoordinator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__2(
                  /*! babylonjs/FlowGraph/flowGraph */
                  "babylonjs/Misc/observable"
                );
                var babylonjs_FlowGraph_flowGraphCoordinator__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__2.n(babylonjs_FlowGraph_flowGraphCoordinator__WEBPACK_IMPORTED_MODULE_1__);
                var _interactivityFunctions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__2(
                  /*! ./interactivityFunctions */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/interactivityFunctions.ts"
                );
                var _interactivityPathToObjectConverter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__2(
                ...
                var KHR_interactivity = (
                  ...
                  function() {
                    ...
                    KHR_interactivity2.prototype.onReady = function() {
                      ...
                      var coordinator = new babylonjs_FlowGraph_flowGraphCoordinator__WEBPACK_IMPORTED_MODULE_1__.FlowGraphCoordinator({ scene });
                      babylonjs_FlowGraph_flowGraphCoordinator__WEBPACK_IMPORTED_MODULE_1__.FlowGraph.Parse(json, { coordinator, pathConverter: this._pathConverter });
                      coordinator.start();
                    };
            ...
            "../../../dev/loaders/src/glTF/2.0/Extensions/index.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                __webpack_require__2.d(__webpack_exports__2, {
                  ...
                  ExtrasAsMetadata: () => (
                    /* reexport safe */
                    _ExtrasAsMetadata__WEBPACK_IMPORTED_MODULE_30__.ExtrasAsMetadata
                  ),
                  /* harmony export */
                  KHR_animation_pointer: () => (
                    /* reexport safe */
                    _KHR_animation_pointer__WEBPACK_IMPORTED_MODULE_24__.KHR_animation_pointer
                  ),
                  /* harmony export */
                  KHR_draco_mesh_compression: () => (
                    /* reexport safe */
                  ...
                  KHR_interactivity: () => (
                    /* reexport safe */
                    _KHR_interactivity__WEBPACK_IMPORTED_MODULE_29__.KHR_interactivity
                  ),
                  /* harmony export */
                  KHR_lights: () => (
                    /* reexport safe */
                  ...
                  KHR_materials_dispersion: () => (
                    /* reexport safe */
                    _KHR_materials_dispersion__WEBPACK_IMPORTED_MODULE_19__.KHR_materials_dispersion
                  ),
                  /* harmony export */
                  KHR_materials_emissive_strength: () => (
                    /* reexport safe */
                  ...
                  KHR_mesh_quantization: () => (
                    /* reexport safe */
                    _KHR_mesh_quantization__WEBPACK_IMPORTED_MODULE_20__.KHR_mesh_quantization
                  ),
                  /* harmony export */
                  KHR_texture_basisu: () => (
                    /* reexport safe */
                    _KHR_texture_basisu__WEBPACK_IMPORTED_MODULE_21__.KHR_texture_basisu
                  ),
                  /* harmony export */
                  KHR_texture_transform: () => (
                    /* reexport safe */
                    _KHR_texture_transform__WEBPACK_IMPORTED_MODULE_22__.KHR_texture_transform
                  ),
                  /* harmony export */
                  KHR_xmp_json_ld: () => (
                    /* reexport safe */
                    _KHR_xmp_json_ld__WEBPACK_IMPORTED_MODULE_23__.KHR_xmp_json_ld
                  ),
                  /* harmony export */
                  MSFT_audio_emitter: () => (
                    /* reexport safe */
                    _MSFT_audio_emitter__WEBPACK_IMPORTED_MODULE_25__.MSFT_audio_emitter
                  ),
                  /* harmony export */
                  MSFT_lod: () => (
                    /* reexport safe */
                    _MSFT_lod__WEBPACK_IMPORTED_MODULE_26__.MSFT_lod
                  ),
                  /* harmony export */
                  MSFT_minecraftMesh: () => (
                    /* reexport safe */
                    _MSFT_minecraftMesh__WEBPACK_IMPORTED_MODULE_27__.MSFT_minecraftMesh
                  ),
                  /* harmony export */
                  MSFT_sRGBFactors: () => (
                    /* reexport safe */
                    _MSFT_sRGBFactors__WEBPACK_IMPORTED_MODULE_28__.MSFT_sRGBFactors
                  )
                  /* harmony export */
                });
                ...
                var _KHR_materials_dispersion__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__2(
                  /*! ./KHR_materials_dispersion */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_materials_dispersion.ts"
                );
                var _KHR_mesh_quantization__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__2(
                  /*! ./KHR_mesh_quantization */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_mesh_quantization.ts"
                );
                var _KHR_texture_basisu__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__2(
                  /*! ./KHR_texture_basisu */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_texture_basisu.ts"
                );
                var _KHR_texture_transform__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__2(
                  /*! ./KHR_texture_transform */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_texture_transform.ts"
                );
                var _KHR_xmp_json_ld__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__2(
                  /*! ./KHR_xmp_json_ld */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_xmp_json_ld.ts"
                );
                var _KHR_animation_pointer__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__2(
                  /*! ./KHR_animation_pointer */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_animation_pointer.ts"
                );
                var _MSFT_audio_emitter__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__2(
                  /*! ./MSFT_audio_emitter */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/MSFT_audio_emitter.ts"
                );
                var _MSFT_lod__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__2(
                  /*! ./MSFT_lod */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/MSFT_lod.ts"
                );
                var _MSFT_minecraftMesh__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__2(
                  /*! ./MSFT_minecraftMesh */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/MSFT_minecraftMesh.ts"
                );
                var _MSFT_sRGBFactors__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__2(
                  /*! ./MSFT_sRGBFactors */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/MSFT_sRGBFactors.ts"
                );
                var _KHR_interactivity__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__2(
                  /*! ./KHR_interactivity */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_interactivity.ts"
                );
                var _ExtrasAsMetadata__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__2(
                  /*! ./ExtrasAsMetadata */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/ExtrasAsMetadata.ts"
                );
              }
            ...
            "../../../dev/loaders/src/glTF/2.0/Extensions/interactivityFunctions.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                var babylonjs_Misc_guid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__2(
                  /*! babylonjs/FlowGraph/flowGraphConnection */
                  "babylonjs/Misc/observable"
                );
                var babylonjs_Misc_guid__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__2.n(babylonjs_Misc_guid__WEBPACK_IMPORTED_MODULE_0__);
                var _interactivityUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__2(
                  /*! ./interactivityUtils */
                ...
                function convertConfiguration(gltfBlock, definition, id) {
                  ...
                  for (var _i = 0, configurationList_1 = configurationList; _i < configurationList_1.length; _i++) {
                    ...
                    if (configObject.id === "customEvent") {
                      ...
                      converted.eventData = customEvent.values.map(function(v) {
                        return v.id;
                      });
                ...
                function convertGLTFToSerializedFlowGraph(gltf) {
                  ...
                  for (var i = 0; i < gltf.nodes.length; i++) {
                    ...
                    var _loop_1 = function(flow2) {
                      var socketOutName = flow2.id;
                      var socketOut = {
                        uniqueId: (0, babylonjs_Misc_guid__WEBPACK_IMPORTED_MODULE_0__.RandomGUID)(),
                        name: socketOutName,
                      ...
                      var nodeInId = flow2.node;
                      var nodeInSocketName = flow2.socket;
                      ...
                      var socketIn = nodeIn.signalInputs.find(function(s) {
                    ...
                    var _loop_2 = function(value2) {
                      var socketInName = value2.id;
                      var socketIn = {
                        uniqueId: (0, babylonjs_Misc_guid__WEBPACK_IMPORTED_MODULE_0__.RandomGUID)(),
                        name: socketInName,
                        _connectionType: babylonjs_Misc_guid__WEBPACK_IMPORTED_MODULE_0__.FlowGraphConnectionType.Input,
                      ...
                      if (value2.value !== void 0) {
                        var convertedValue = convertValueWithType(value2, gltf, "/extensions/KHR_interactivity/nodes/".concat(i));
                        context._connectionValues[socketIn.uniqueId] = convertedValue;
                      } else if (value2.node !== void 0 && value2.socket !== void 0) {
                        var nodeOutId = value2.node;
                        var nodeOutSocketName_1 = value2.socket;
                        ...
                        var socketOut = nodeOut.dataOutputs.find(function(s) {
                          return s.name === nodeOutSocketName_1;
                        });
                        if (!socketOut) {
                          socketOut = {
                            uniqueId: (0, babylonjs_Misc_guid__WEBPACK_IMPORTED_MODULE_0__.RandomGUID)(),
            ...
            "../../../dev/loaders/src/glTF/2.0/Extensions/interactivityPathToObjectConverter.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                var _gltfPathToObjectConverter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__2(
                  /*! ./gltfPathToObjectConverter */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/gltfPathToObjectConverter.ts"
                );
                var InteractivityPathToObjectConverter = (
                  /** @class */
                  function(_super) {
                    (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__extends)(InteractivityPathToObjectConverter2, _super);
                    function InteractivityPathToObjectConverter2(gltf) {
                      return _super.call(this, gltf, gltfTree) || this;
                    }
                    return InteractivityPathToObjectConverter2;
            ...
            "../../../dev/loaders/src/glTF/2.0/Extensions/interactivityUtils.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                var babylonjs_FlowGraph_Blocks_Event_flowGraphSceneReadyEventBlock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__2(
                  /*! babylonjs/FlowGraph/Blocks/Execution/ControlFlow/flowGraphWhileLoopBlock */
                  "babylonjs/Misc/observable"
                );
                var babylonjs_FlowGraph_Blocks_Event_flowGraphSceneReadyEventBlock__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__2.n(babylonjs_FlowGraph_Blocks_Event_flowGraphSceneReadyEventBlock__WEBPACK_IMPORTED_MODULE_0__);
                    ...
                    GLTFLoader2.prototype._checkExtensions = function() {
                      if (this._gltf.extensionsRequired) {
                        var _loop_1 = function(name_22) {
                          ...
                          if (!available) {
                            throw new Error("Required extension ".concat(name_22, " is not available"));
                          }
                        };
                        var this_1 = this;
            ...
            "../../../dev/loaders/src/glTF/2.0/index.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                __webpack_require__2.d(__webpack_exports__2, {
                  ...
                  KHR_interactivity: () => (
                    /* reexport safe */
                    _Extensions_index__WEBPACK_IMPORTED_MODULE_3__.KHR_interactivity
                  ),
                  /* harmony export */
                  KHR_lights: () => (
                    /* reexport safe */
                  ...
                  KHR_materials_dispersion: () => (
                    /* reexport safe */
                    _Extensions_index__WEBPACK_IMPORTED_MODULE_3__.KHR_materials_dispersion
                  ),
                  /* harmony export */
                  KHR_materials_emissive_strength: () => (
                    /* reexport safe */
